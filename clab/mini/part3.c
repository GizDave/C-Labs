 ...
 *
 * You are expected to first use prime_number_sieves to first find all primes smaller
 * than  n. Then, test if any prime found by prime_number_sieves divide n and return the 
 * smallest one.
